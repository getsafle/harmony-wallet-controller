...
class KeyringController extends EventEmitter {
     ...
     *
     * Signs an Harmony transaction object.
     *
     * @param {Object} harmonyTx - The transaction to sign.
     * @param {Object} web3 - web3 object.
     * @returns {string} The signed transaction raw string.
     */

    async signTransaction(harmonyTx, privateKey) {
        const tx = new Tx(harmonyTx);
    ...
    async getFees(harmonyTx, web3) {
        const { from, to, value, data, gasLimit } = harmonyTx
